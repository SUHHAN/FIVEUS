...
public class talkwithjjang_yj : MonoBehaviour
{
    ...
    //public GameObject heyGotoBed_yj; // 잠 자러 가라
    ...
    public static talkwithjjang_yj Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<talkwithjjang_yj>();
                if (_instance == null)
                {
                    GameObject obj = new GameObject("talkwithjjang_yj");
                    _instance = obj.AddComponent<talkwithjjang_yj>();
                }
            }
            return _instance;
        }
